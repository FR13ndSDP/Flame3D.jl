...
function advect_xc(F, ϕ, S, Fp, Fm, Q, Ax, Ay, Az)
    ...
    if ϕx < hybrid_ϕ1
        ...
        @inbounds p = 0.5f0 * (Q[i, j, k, 5] + Q[i-1, j, k, 5])
        @inbounds ei = 0.5f0 * (Q[i, j, k, 7] + Q[i-1, j, k, 7])
...
function advect_yc(F, ϕ, S, Fp, Fm, Q, Ax, Ay, Az)
    ...
    if ϕx < hybrid_ϕ1
        ...
        @inbounds p = 0.5f0 * (Q[i, j, k, 5] + Q[i, j-1, k, 5])
        @inbounds ei = 0.5f0 * (Q[i, j, k, 7] + Q[i, j-1, k, 7])
...
function advect_zc(F, ϕ, S, Fp, Fm, Q, Ax, Ay, Az)
    ...
    if ϕx < hybrid_ϕ1
        ...
        @inbounds p = 0.5f0 * (Q[i, j, k, 5] + Q[i, j, k-1, 5])
        @inbounds ei = 0.5f0 * (Q[i, j, k, 7] + Q[i, j, k-1, 7])
