...
//   CKXTY(Xt, Yt);
  ...
  for (int iter = 0; iter < niter; ++iter) {
    ...
    cout << "Mass frac of H2:  " << Yt[0] << endl;
    cout << "Mass frac of O2:  " << Yt[1] << endl;
    cout << "Mass frac of H2O: " << Yt[2] << endl;
